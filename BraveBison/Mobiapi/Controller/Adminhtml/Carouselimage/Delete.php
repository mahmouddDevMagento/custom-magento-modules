...
use BraveBison\Mobiapi\Model\CarouselimageFactory;
    ...
    public function execute()
    {
        ...
        if ($id) {
            try {
                ...
                if (!$model->getId()) {
                    throw new \Exception(__('This Carousel Images no longer exists.'));
                }

                $model->delete();
                $this->messageManager->addSuccessMessage(__('You deleted the Carousel Images.'));
            } catch (\Exception $e) {
