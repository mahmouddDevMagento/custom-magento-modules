...
class AssignProducts extends \Magento\Backend\Block\Template
{
    ...
    public function getBlockGrid()
    {
        if (null === $this->blockGrid) {
            $this->blockGrid = $this->getLayout()->createBlock(
                'BraveBison\Mobiapi\Block\Adminhtml\Carousel\Tab\Productgrid',
    ...
    public function getProductsJson()
    {
        ...
        $productIds = explode(",", $carouselProducts);
...
//            foreach ($imageCollection->getData() as $products) {
//                $result[$products['id']] = '';
//            }
...
//    }
    ...
    {
        return $this->registry->registry('carousel');
    }
}